...
monkey=createSprite(200,550,20,20)
monkey.addAnimation("monkeyrun",monkey1)
monkey.scale=0.2;
ground=createSprite(200,550,displayWidth,5);
...
text("Reach 500 score to win!!!:D",400,100)
text("DONT TOUCH THE STONE OR YOU WILL DIE!!!! ;",400,200)
}

function stone() {
if(frameCount % 300 === 0) {
    var stones = createSprite(400,550,10,40);
    stones.velocityX=-3;
    stones.addImage(s);
    stones.scale = 0.1;
    stones.lifetime = 134;
...
function banana() {
if(frameCount % 150 === 0) {
    var fruit = createSprite(400,450,10,40);
    fruit.velocityX=-3;
    fruit.addImage(b);
    fruit.scale = 0.1;
    fruit.lifetime = 134;
